    ...
    <div>
      ...
      {user?.isAdmin && (
        <WrapperItemtHeader onClick={() => navigate("/admin/user")}>
          <WrapperContentHeader>Quản lí hệ thống</WrapperContentHeader>
        </WrapperItemtHeader>
      )}
        ...
        <Flex vertical gap={8} flex={1}>
          <Flex gap={20}>
            ...
            <Flex gap={8}>
              ...
              {user.name || user.email ? (
                ...
                <WrapperButtonHeader className="" onClick={showModal}>
                  <Flex align="center" gap={5}>
              ...
              >
                <Badge count={user?.id && order?.orderItems?.length} size="small">
                  <ShoppingCartOutlined
                    style={{
                      fontSize: "22px",
          ...
          <Flex>
            ...
            <Flex justify="space-between" wrap="nowrap">
              <CiLocationOn size={22} style={{ color: "rgb(128, 128, 137)" }} />
              <WrapperLocationHeader>
                Giao đến :
                <WrapperAddressHeader>

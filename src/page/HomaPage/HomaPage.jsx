...
function HomaPage() {
  ...
  const fetchProductFashionAll = async () => {
    const res = await ProductService.getAllProduct(1, 0, "type", valueProduct);
    return res;
  };
  ...
  const productsTechnology = dataTechnology && splitArray(dataTechnology.data);
    ...
    <Flex vertical gap={16}>
      ...
      <WrapperItemContent>
        <Flex vertical gap={10}>
          <WrapperDescriptionContent>Thời trang</WrapperDescriptionContent>
          <Flex gap={12}>
            <WrapperButtonCarouselContent
              className={valueProduct === "Thời trang nam" ? "active" : ""}
              onClick={() => {
            ...
            <WrapperButtonCarouselContent
              className={valueProduct === "Túi thời trang nam" ? "active" : ""}
              onClick={() => {
            ...
            <WrapperButtonCarouselContent
              className={valueProduct === "Giày - Dép nam" ? "active" : ""}
              onClick={() => {
            ...
            <WrapperButtonCarouselContent
              className={valueProduct === "Thời trang nữ" ? "active" : ""}
              onClick={() => {
            ...
            <WrapperButtonCarouselContent
              className={valueProduct === "Giày - Dép nữ" ? "active" : ""}
              onClick={() => {
            ...
            <WrapperButtonCarouselContent
              className={valueProduct === "Túi thời trang nữ" ? "active" : ""}
              onClick={() => {
      ...
      <WrapperItemContent>
        <Flex vertical gap={10}>
          <WrapperDescriptionContent>Công nghệ</WrapperDescriptionContent>
          <Flex gap={12}>
            <WrapperButtonCarouselContent
              className={
                valueProductTechnology === "Điện Thoại - Máy Tính Bảng"
                  ? "active"
                  : ""
              }
              onClick={() => {
                handleChangeTypeTechonology("Điện Thoại - Máy Tính Bảng");
              }}
            >
              Điện Thoại - Máy Tính Bảng
            </WrapperButtonCarouselContent>
            <WrapperButtonCarouselContent
              className={
                valueProductTechnology === "Laptop - Máy Vi Tính - Linh kiện"
                  ? "active"
                  : ""
              }
              onClick={() => {
                handleChangeTypeTechonology("Laptop - Máy Vi Tính - Linh kiện");
              }}
            >
              Laptop - Máy Vi Tính - Linh kiện
            </WrapperButtonCarouselContent>
          </Flex>
          <LoadingComponent isPending={isLoadingTechnology || isFetching}>
